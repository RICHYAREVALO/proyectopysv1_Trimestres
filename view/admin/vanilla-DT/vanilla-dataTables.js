...
(function(root, factory) {
    ...
    var defaultConfig = {
        ...
        labels: {
            placeholder: "Búsqueda...", // The search input placeholder
            perPage: "{select} Entradas por Página", // per-page dropdown label
            noRows: "Sin contenido encontrado", // Message shown when there are no search results
